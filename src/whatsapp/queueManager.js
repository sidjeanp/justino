...
redisClient.on('connect', () => {
    console.log(`[${getFormattedDateTime()}] Conexão estabelecida com o Redis!`);
});
...
async function addToQueue(message) {
    try {
        ...
        console.log(`[${getFormattedDateTime()}] Mensagem adicionada à fila:`, message);
    } catch (error) {
        console.error(`[${getFormattedDateTime()}] Erro ao adicionar mensagem à fila:`, error.message);
    } finally {
