  ...
  apps: [
    {
      ...
      env: {
        ...
        REDIS_HOST: 'redis',
        REDIS_PORT: 6379,
        MONGO_URI: 'mongodb://root:example@mongo:27017/justino?authSource=admin',
      },
      env_production: {
        NODE_ENV: 'production',
        REDIS_HOST: process.env.REDIS_HOST || 'redis',
        REDIS_PORT: process.env.REDIS_PORT || 6379,
        MONGO_URI: process.env.MONGO_URI || 'mongodb://root:example@mongo:27017/justino?authSource=admin',
      },
      autorestart: false,
      max_restarts: 5,
      restart_delay: 10000,
